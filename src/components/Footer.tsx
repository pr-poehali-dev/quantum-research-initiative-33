export function Footer() {
  const footerLinks = {
    "Геймплей": ["Банды", "Гонки", "Перестрелки", "Миссии", "Территории", "PvP", "Открытый мир"],
    "Персонаж": ["Прокачка", "Скины", "Тюнинг авто", "Навыки", "Инвентарь", "Репутация", "Достижения"],
    "Сообщество": ["О игре", "Новости", "Форум", "Гайды", "Стримеры", "Партнёры", "Пресс-кит"],
    "Поддержка": ["Помощь", "Статус серверов", "Баг-репорт", "Конфиденциальность", "Условия", "Возраст 18+", "EULA"],
    "Контакты": ["Написать нам", "Discord", "Telegram", "VK", "YouTube"],
  }
